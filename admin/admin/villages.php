									...
									while ($row = mysqli_fetch_array($table)) {
										...
										<div class='card'>
											<div class='jobs2 card-body'>
												...
												<a href='https://villageonweb.in/villages/$row[village_name]/admin' target='_blank' class='btn btn-sm btn-outline-primary rounded me-2 mt-3'> Admin Login</a>
								...
								<div class="row">
									...
									<div class="col-12">
										...
										while ($row = mysqli_fetch_array($table)) {
											...
											<div class='d-flex col-xl-3 col-xxl-4 col-lg-4 col-sm-6 align-items-center'>
												<img src='images/database.png' alt='Icon description' class='me-3 ml-lg-0 ml-sm-auto ms-0 mt-sm-0 mt-3' width='54' height='54'>
											...
											<div class='d-flex col-xl-3 col-xxl-4 col-lg-4 col-sm-6 mt-lg-0 mt-3 align-items-center'>
												<img src='images/user-svg.png' alt='Icon description' class='me-3 ml-lg-0 ml-sm-auto ms-0 mt-sm-0 mt-3' width='54' height='54'>
												<div>
