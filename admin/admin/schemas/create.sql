...
CREATE TABLE `pillarofcommunity` (
  ...
  `photo` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '["no-profile.png"]' CHECK (json_valid(`photo`)),
...
CREATE TABLE `population` (
  ...
  `villageid` int(11) DEFAULT NULL,
  `totalnoofmale` int(11) NOT NULL,
  `totalnooffemale` int(11) NOT NULL,
