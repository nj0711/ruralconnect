...
<body>
    <div class="login-container">
        ...
        <form id="loginForm" action="update-account.php" method="POST" onsubmit="return validateForm()">
            ...
            <button type="submit" name='insert' class="login-btn">Change Password</button>
