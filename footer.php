					...
					<div class="footer-widget">
						<div class="footer-widget-explore">
							...
							<ul class="list-unstyled">
								<li><a href="villages/karamsad/index.php">Karamsad</a></li>
								<li><a href="villages/tarapur/index.php">Tarapur</a></li>
								<li><a href="villages/changa/index.php">Changa</a></li>
								<li><a href="villages/bantwa/index.php">Bantwa</a></li>
							</ul><!-- list-unstyled -->
				...
				<div class="col-lg-2">
					<div class="footer-widget">
						<div class="footer-widget-department">
							...
							<ul class="list-unstyled">
								<li><a href="villages-list.php">Villages List</a></li>
...
<div class="mobile-nav-wrapper">
	...
	<div class="mobile-nav-content">
		...
		<div class="logo-box">
			<a href="index.php"><img src="assets/image/logo1.png" width="80" alt="26"></a>
		</div><!-- logo-box -->
