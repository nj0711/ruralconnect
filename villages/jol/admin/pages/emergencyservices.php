  ...
  `visibility` varchar(5) NOT NULL DEFAULT 'off'
                        ...
                        if (isset($_POST['emergencyservicesID']) && $_POST['emergencyservicesID'] != "") {
                            ...
                            if ($ServiceName != "" && $ServiceType != "" && $contactNo != "" && $VillageID != "") {
                                ...
                                $sql = "INSERT INTO emergencyservices 
                                            (servicename, servicetype, contactnumber, address, villageid) 
                                            VALUES 
                 ...
                 <div class="row">
                     ...
                     <div class="import-section" style="margin: 30px 0; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f8f9fa;" id="import-section">
                         <h4>🚨 Bulk Import Emergency Services</h4>
                         <p class="text-muted mb-3">
                             <strong>How it works:</strong> Download the template, fill in the emergency services data, and import.
                             <strong>Village ID is automatically assigned</strong> - you don't need to fill it.
                         </p>

                         <div class="row align-items-center g-3">
                             <div class="col-md-4">
                                 <a href="templates/emergencyservices_template.php" class="btn btn-info w-100">
                                     📥 Download Template
                                 </a>
                             </div>
                             <div class="col-md-8">
                                 <form action="imports/import_emergencyservices.php" method="post" enctype="multipart/form-data" class="d-flex gap-2">
                         ...
                         <div class="mt-3 p-2  border rounded">
                             <small class="text-muted">
                                 <strong>💡 Required fields:</strong> Service Name, Service Type, Contact Number<br>
                                 <strong>📝 Optional fields:</strong> Address, City, Zip<br>
                                 <strong>⚠️ Notes:</strong><br>
                                 • <strong>Service Type:</strong> Fire, Police, Medical, Other - defaults to Other<br>
                                 • <strong>Contact Number:</strong> 3-15 digit numbers (101, 100, 108, etc.)<br>
