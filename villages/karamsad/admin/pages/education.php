        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="import-section" style="margin: 30px 0; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f8f9fa;" id="import-section">
                    <h4>📚 Bulk Import Education Institutions</h4>
                    <p class="text-muted mb-3">
                        <strong>How it works:</strong> Download the template, fill in the education data, and import.
                    ...
                    <div class="row align-items-center g-3">
                        <div class="col-md-4">
                            <a href="templates/education_template.php" class="btn btn-info w-100">
                                📥 Download Template
                            </a>
                        </div>
                        <div class="col-md-8">
                            <form action="imports/import_education.php" method="post" enctype="multipart/form-data" class="d-flex gap-2">
                    ...
                    <div class="mt-3 p-2  border rounded">
                        <small class="text-muted">
                            ...
                            <strong>📝 Optional fields:</strong> City, Zip, Phone, Email, Facilities, Description<br>
                            <strong>⚠️ Notes:</strong><br>
                            • <strong>Type:</strong> scl (School) or clg (College) - defaults to School<br>
