            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="import-section" style="margin: 30px 0; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f8f9fa;" id="import-section">
                        <h4>🏥 Bulk Import Hospitals & Medical Facilities</h4>
                        <p class="text-muted mb-3">
                            <strong>How it works:</strong> Download the template, fill in the hospital data, and import.
                        ...
                        <div class="row align-items-center g-3">
                            <div class="col-md-4">
                                <a href="templates/hospitals_template.php" class="btn btn-info w-100">
                                    📥 Download Template
                                </a>
                            </div>
                            <div class="col-md-8">
                                <form action="imports/import_hospitals.php" method="post" enctype="multipart/form-data" class="d-flex gap-2">
                        ...
                        <div class="mt-3 p-2  border rounded">
                            <small class="text-muted">
                                <strong>💡 Required fields:</strong> Name, Type<br>
                                <strong>📝 Optional fields:</strong> Address, City, Zip, Contact, Patient Capacity, Description<br>
                                <strong>⚠️ Notes:</strong><br>
                                • <strong>Type:</strong> Hospital, Medical Shop, Care Center - defaults to Hospital<br>
                                • <strong>Contact Number:</strong> 10-digit phone number<br>
                                • <strong>Zip Code:</strong> 6-digit number (e.g., 388001)<br>
                                • <strong>Time Schedule:</strong> JSON format <code>{"open":"08:00","close":"20:00"}</code><br>
                                • <strong>Patient Capacity:</strong> Number (0 for non-hospital facilities)<br>
