...
<head>
    ...
    <title>Hotels || Village On Web</title>
    <!-- google font -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="department-one-section">
            ...
            $result = $obj->selectdata("hotels", $values);
            ?>
            <div class="container">
                <!-- <center>
                ...
                <div class="row row-gutter-30">
                    <?php
						if (empty($result)) {
							echo "<h2 style='margin-bottom: 50px;'>Hotels</h2>";
						}
						else {
						foreach ($result as $index => $row) { 
                            if($row['visibility']=='on'){
                                    ...
                                    <div class="text-content">
                                        ...
                                        <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                            <?php // Retrieve concatenated address, city, pincode
                                                $addressCityPincode = $row['address'];
                                                $modifiedAddress = str_replace('@', ', ', $addressCityPincode);
                                                echo $modifiedAddress ?></p>
                                        <p><strong>Website</strong>:<?php echo $row['websitelink']; ?></p>
                                        <p><strong>Booking Process</strong>:<?php  $bookingOption = $row['bookingprocess'];
                                            if ($bookingOption === "both") {echo "Both online & offline"; }else{echo $row['bookingprocess'];}
                                            ?></p>
                                        <p><strong>Amenities</strong>:<?php echo $row['amenities']; ?></p>
                                        <p><strong>Customer reviews</strong>: <?php echo $row['customerreviews']; ?></p>
                                        <p><strong>Hours</strong>: (Hours might differ)<br>
                                            <?php $timings = json_decode($row['timeschedule'], true); ?>
                                            Opening Time:<?php echo $timings['open']; ?> <br>
                                            Closing Time: <?php echo $timings['close']; ?>
                                        </p>
        ...
        <section class="department-one-section">
            ...
            <?php 
            $values = 'SELECT * FROM restaurants';

            $result = $obj->selectdata("restaurants", $values);
            ?>
            <div class="container">
                <!-- <center>
					<h2 style="margin-bottom: 50px;">Schools</h2>
                ...
                <div class="row row-gutter-30">
                    <?php
						if (empty($result)) {
                            ...
                            foreach ($result as $index => $restaurants) { 
                                $modalId = "my2Modal" . $index;
                                ?>
                    <!-- card -->
                    <div class=" col-lg-6 col-xl-4 ">
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                <div class="department-two-img">
                                    <img src="<?php
                                                            $photos = json_decode($restaurants['photo'], true);
                            ...
                            <div class="department-two-content">
                                <h4><a>
                                        <?php
                                                    echo $restaurants['restaurantname'];
                                                    ?>
                                    </a></h4>
                                <br>
                                <div class="department-two-button">
                            ...
                            <b><span class="close" onclick="close2Modal('<?php echo $modalId; ?>')">&times;</span>
                                <div class="modal-body">
                                    <div class="text-content">
                                        ...
                                        <p><strong>Customer reviews</strong>: <?php echo $row['customerreviews']; ?>
                                        </p>
                                        <p><strong>Hours</strong>: (Hours might differ)<br>
                                            <?php $timings = json_decode($row['timeschedule'], true); ?>
                                            Opening Time:<?php echo $timings['open']; ?> <br>
