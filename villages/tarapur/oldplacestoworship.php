...
<head>
    ...
    <title>Places to Worship || Village On Web</title>
    <!-- google font -->
            ...
            <div class="container">
                <div class="row row-gutter-30">
					...
					if ($result!='No Data Found!') {
						foreach ($result as $row => $worship) { 
                            if($worship['visibility']=='on'){
							$modalId = "myModal" . $row;
							?>
                        ...
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                <div class="department-two-img">
                                    <img src="<?php
														$photos = json_decode($worship['photo'], true);
														// print_r($photos);
                                ...
                                <div class="modal-body">
                                    <div class="text-content">
                                        ...
                                        <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                            <?php
													$cleanedAddress = str_replace('@', ',', $worship['address']);
													echo $cleanedAddress;
													?>
                                        </p>
                                        <p>
                                            <b>Weekdays</b><br>
                                            <?php
                                            $time = json_decode($worship['timeschedule'], true);
                                             if(isset($time['weekdayopenkey']) && isset($time['weekdayclosekey'])){
                                               
                                                $weekopen = $time['weekdayopenkey'];
                                                $weekclose = $time['weekdayclosekey'];
                                                echo 'Opening time : ';
                                                echo $weekopen; 
                                                echo '<br>';
                                                echo 'Closing time : ';
                                            ...
                                            <b>Weekend</b><br>
                                            <?php
                                            if(!isset($time['weekendopenkey']) && !isset($time['weekendclosekey'])){
                                                echo 'Not Mentioned!';
                                            }else{
                                                $weekopen = $time['weekendopenkey'];
                                                $weekclose = $time['weekendclosekey'];
                                                if(!$weekopen && !$weekclose){
                                                    echo "Close on Weekends";
                                                }else {
                                                echo 'Opening time : ';
                                                echo $weekopen; 
                                                echo '<br>';
                                    ...
                                    <div class="text-content">
                                        ...
                                        <p> <b>History:</b> <br>
                                            ...
                                            <?php
													echo $worship['history'];
													?>
                                        </p>
                                        <p> <b>Other Information:</b><br>

                                            <?php
													echo $worship['description'];
													?>
                                        </p>
                                    </div>
                                </div>
