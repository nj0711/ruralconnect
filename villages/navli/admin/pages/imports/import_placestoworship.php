<?php
// imports/import_placestoworship.php
...
// Define the exact fields from your template (EXCLUDING villageid and placestoworshipid)
$expected_headers = [
    'name',
    'history',
    'photo',
    ...
    if (!empty($imported_data)) {
        ...
        foreach ($imported_data as $row_data) {
            ...
            if ($chk == "No Data Found!") {
                // Try to insert
                if (insertPlacesToWorshipRecord($row_data, $obj, $table_name)) {
                    $inserted_count++;
                } else {
                    $error_count++;
                }
            ...
            <div class='container results-container'>
                <div class='card'>
                    <div class='card-header'>
                        <h4 class='card-title'>Places to Worship Import Results</h4>
                    </div>
                    <div class='card-body'>
        ...
        echo "</div>
                        <div class='d-flex gap-2 flex-wrap'>
                            <a href='../editform.php?tablename=placestoworship' class='btn btn-primary back-btn'>⛪ View Places List</a>
                            <a href='../placestoworship.php' class='btn btn-secondary back-btn'>➕ Add New Place</a>
                            <a href='../placestoworship.php#import-section' class='btn btn-info back-btn'>📥 Import More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <body>
            <div class='container results-container'>
                ...
                <a href='../placestoworship.php' class='btn btn-primary'>🔄 Try Again</a>
            </div>
        </body>
        </html>";
    }
...
// Function to insert places to worship record into database (villageid auto-added, photo as empty JSON)
function insertPlacesToWorshipRecord($data, $obj, $table_name)
{
    try {
            ...
            if (isset($field_types[$field])) {
                switch ($field_types[$field]) {
                    ...
                    case 'text':
                        ...
                        break;
                    case 'json':
                        // Handle timeschedule as JSON (weekday/weekend open/close times)
        ...
        error_log("Places to worship import error: " . $e->getMessage());
        return false;
    }
}
