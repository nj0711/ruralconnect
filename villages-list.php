...
<head>
	...
	<link rel="stylesheet" type="text/type" href="assets/vendor/flaticon/css/flaticon_towngov.css">
...
<body>
				...
				<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4"><?php
							...
							<div class="village-card">
								...
								<div class="village-card-content">
									<div class="card-location"><i class="fas fa-map-pin"></i><span><?php echo $vName; ?>,
											Anand,
											Gujarat</span></div>
									<h3 class="card-title"><a href="villages/<?php echo $villageSlug; ?>/index.php" class="card-link"><?php echo $vName; ?></a></h3>
									<div class="card-footer"><button class="btn-explore" onclick="window.location.href='villages/<?php echo $villageSlug; ?>/index.php'"><span>Discover More</span><i class="fas fa-arrow-right"></i></button></div>
								</div>
							</div>
						</div><?php } ?></div>
			</div>
	...
	<div class="search-popup">
		...
		<div class="search-popup-content">
			<form action="search_village.php" method="GET"><label for="search" class="sr-only">search here</label>
				<!-- sr-only -->
				<input type="text" id="search" name="village_name" placeholder="Search Here..." required><button type="submit" aria-label="search submit" class="search-btn"><span><i class="flaticon-search-interface-symbol"></i></span></button>
				<!-- search-btn -->
			</form>
			<!-- form -->
		</div>
