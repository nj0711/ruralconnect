...
<div class="page-wrapper">
	...
	<div class="portfolio-carousel owl-carousel owl-theme">
		<?php 
			// Fetch village names
			$result = mysqli_query($conn, "SELECT DISTINCT village_name FROM villages LIMIT 4");
			...
			while ($row = mysqli_fetch_assoc($result)) {
				...
				// Define folder path
				$folderPath = "villages/" . $villageName . "/";

				// Look for the first image in the folder
				$imageFiles = glob($folderPath . "*.{jpg,jpeg,png,gif}", GLOB_BRACE);

				// If an image is found, use it; otherwise, use a default
				$imagePath = (!empty($imageFiles)) ? $imageFiles[0] : "assets/image/portfolio/default.jpg";
		?>
			<div class="item">
				<div class="portfolio-card">
					<a href="villages/<?php echo $villageName; ?>/index.php">
						<img src="<?php echo $imagePath; ?>" class="img-fluid" alt="<?php echo $vName; ?>" style="height:250px; object-fit:cover;">
						<div class="portfolio-card-text text-center mt-2">
							<a href="villages/<?php echo $villageName; ?>/index.php"><?php echo $vName; ?></a>
						</div>
					</a>
				</div><!-- portfolio-card -->
			</div><!-- item -->
