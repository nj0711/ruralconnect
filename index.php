	...
	<div class="page-wrapper">
		<section class="main-slider">
			<div class="main-slider-swiper owl-carousel owl-theme">
				<div class="item">
					<div class="item-slider-bg" style="background-image: url(assets/image/bg/vlg2.jpg);"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-12">
				...
				<div class="item">
					<div class="item-slider-bg" style="background-image: url(assets/image/bg/vlg1.jpg);"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<div class="slider-content">
					...
					<div class="col-lg-6">
						<div class="about-inner">
							<div class="section-title-box">
								...
								<h5 class="section-title">Welcome to Village On Web</h5>
