...
<head>
    ...
    <title>Events Festivals || Village On Web</title>
    <!-- google font -->
...
<body>
	...
	$values = 'SELECT * FROM  eventsfestivals';
        ...
        <section class="department-one-section">
            <div class="container">
                ...
                <div class="row row-gutter-30">
                    <?php
						if (empty($result)) {
							echo "<h2 style='margin-bottom: 50px;'>Events Festivals</h2>";
						}
						else {
						foreach ($result as $row => $events) { 
                            if($events['visibility']=='on'){
							$modalId = "myModal" . $row;
							?>
                    <!-- card -->
                        ...
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                <div class="department-two-img">
                                    <img src="eventsfestival.jpg" class="img-fluid" alt="img-150">';
                            ...
                            <b><span class="close" onclick="closeModal('<?php echo $modalId; ?>')">&times;</span>
                                <div class="modal-body">
                                    <div class="text-content">
                                        <h1><?php echo $events['eventname']; ?></h1>
                                        <br>
                                        <p><strong>Type of Event</strong>:<br>
                                            <?php echo $events['eventtype']; ?></p>
                                        <p><strong>Event Description</strong>:<br><?php echo $events['description']; ?>
                                        </p>
                                        <p><strong>Event Date</strong>:<br>
                                            Start Date:<?php echo $events['startdate']; ?> <br>
                                            End Date: <?php echo $events['enddate']; ?>
                                        </p>
                                        <p><strong>Contact No</strong>:<?php echo $events['contactnumber']; ?></p>
                                    </div>
