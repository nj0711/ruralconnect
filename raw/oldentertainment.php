...
<head>
    ...
    <title>Entertainment || RuralConnect Web</title>
    <!-- google font -->
            ...
            <div class="container">
                ...
                <div class="row row-gutter-30">
                    <?php
						...
						foreach ($result as $row => $entertainment) { 
                            if($entertainment['visibility']=='on'){
							$modalId = "myModal" . $row;
							?>
                    <!-- card -->
                        ...
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                <div class="department-two-img">
                                    <img src="<?php
														$photos = json_decode($entertainment['photo'], true);
														// print_r($photos);
                            ...
                            <b><span class="close" onclick="closeModal('<?php echo $modalId; ?>')">&times;</span>
                                <div class="modal-body">
                                    <div class="text-content">
                                        <h1><?php echo $entertainment['name']; ?></h1>
                                        <br>
                                        <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                            <?php // Retrieve concatenated address, city, pincode
												$addressCityPincode = $entertainment['address'];
												$modifiedAddress = str_replace('@', ', ', $addressCityPincode);
												echo $modifiedAddress ?></p>
                                        <p><strong>Type Entertainment</strong>:<br>
                                            <?php echo $entertainment['type']; ?></p>
                                        <p><strong>Description</strong>: <br> <?php echo $entertainment['description']; ?></p>
                                        <p><strong>Hours</strong>: (Hours might differ)<br>
                                            <?php $timings = json_decode($entertainment['timeschedule'], true); ?>
                                            Opening Time:<?php echo $timings['weekdayopenkey']; ?> <br>
                                            Closing Time: <?php echo $timings['weekdayclosekey']; ?>
                                        </p>
                                        <p><strong>Contact No</strong>:<?php echo $entertainment['contactno']; ?></p>
                                    </div>
