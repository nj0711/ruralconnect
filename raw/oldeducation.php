...
<head>
    ...
    <title>Education || RuralConnect Web</title>
    <!-- google font -->
            ...
            <div class="container">
                ...
                <div class="row row-gutter-30">
                    ...
                    if (empty($result)) {
                        ...
                        foreach ($result as $row => $education) {
                            if ($education['visibility'] == 'on') {
                                $modalId = "myModal" . $row;
                    ?>
                                <!-- card -->
                                    ...
                                    <div class="department-two-card">
                                        <div class="department-two-imgbox">
                                            <div class="department-two-img">
                                                <img src="<?php
                                                            $photos = json_decode($education['photo'], true);
                                                            // print_r($photos);
                                            ...
                                            <div class="modal-body">
                                                <div class="text-content">
                                                    ...
                                                    <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                                        <?php
                                                        $cleanedAddress = str_replace('@', ',', $education['address']);
                                                        echo $cleanedAddress;
                                                        ?>
                                                    </p>
                                                    <p> <b>Contact no:</b>
                                                        <?php
                                                        echo $education['contactno'];
                                                        ?>
                                                    </p>
                                                    <p><b> Courses Available:</b>
                                                        <?php
                                                        echo $education['facilityavailable'];
                                                        ?>
                                                    </p>
                                                    <p> <b>Email Id :</b>
                                                        <?php
                                                        echo $education['emailid'];
                                                        ?>
                                                    </p>
                                                </div>
                                                <div class="text-content">
