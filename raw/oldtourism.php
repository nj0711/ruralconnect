...
<head>
    ...
    <title>Tourism || RuralConnect Web</title>
    <!-- google font -->
            ...
            <div class="container">
                <div class="row row-gutter-30">
					...
					if ($result!='No Data Found!') {
						foreach ($result as $row => $places) { 
                            if($places['visibility']=='on'){
							$modalId = "myModal" . $row;
							?>
                        ...
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                <div class="department-two-img">
                                    <img src="<?php
														$photos = json_decode($places['photo'], true);
														// print_r($photos);
                                ...
                                <div class="modal-body">
                                    <div class="text-content">
                                        ...
                                        <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                            <?php
													$cleanedAddress = str_replace('@', ',', $places['address']);
													echo $cleanedAddress;
													?>
                                        </p>
                                        ...
                                        <p><b> Entry fees:</b>
                                            <?php
													echo $places['entryfees'];
													?>
                                        </p>
                                        <p>
                                            <b>Weekdays</b><br>
                                            <?php
													$time = json_decode($places['timeduration'], true);
                                    ...
                                    <div class="text-content">
                                        ...
                                        <p> <b>Facilities: </b><br>
                                            ...
                                            <?php
													echo $places['amenitiesfacilities'];
													?>
                                        </p>
