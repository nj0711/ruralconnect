...
<head>
    ...
    <title>Emploment Centers || RuralConnect Web</title>
    <!-- google font -->
        ...
        <section class="department-one-section">
            <div class="container">
                ...
                <div class="row row-gutter-30">
                    <?php
						if (empty($result)) {
							echo "<h2 style='margin-bottom: 50px;'>Emploment Centers</h2>";
						}
						else {
						foreach ($result as $row => $centers) { 
                            if($centers['visibility']=='on'){
							$modalId = "myModal" . $row;
							?>
                    <!-- card -->
                    <div class=" col-lg-6 col-xl-4 ">
                        <div class="department-two-card">
                            <div class="department-two-imgbox">
                                ...
                                <img src="employmentcenters.jpg" class="img-fluid" alt="img-150">';
                                </div><!-- department-two-img -->
                            </div><!-- department-two-imgbox -->
                            <div class="department-two-content">
                                <h4><a>
                                        <?php
												echo $centers['centername'];
												?>
                                    </a></h4>
                                <br>
                        ...
                        <div class="modal-content">
                            <b><span class="close" onclick="closeModal('<?php echo $modalId; ?>')">&times;</span>
                                <div class="modal-body">
                                    ...
                                    <h1><?php echo $centers['centername']; ?></h1>
                                    <br>
                                    <p><i class="fa-solid fa-location-dot">&nbsp;</i>
                                        <?php // Retrieve concatenated address, city, pincode
												$addressCityPincode = $centers['address'];
												$modifiedAddress = str_replace('@', ', ', $addressCityPincode);
												echo $modifiedAddress ?></p>
                                    <p><strong>Type of Service</strong>:<br>
                                        <?php echo $centers['servicetype']; ?></p>                           
                                    <p><strong>Contact No</strong>:<?php echo $centers['contactnumber']; ?></p>
                                    </div>
