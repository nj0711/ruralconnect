...
<head>
    ...
    <title>Health || Village On Web</title>
    <!-- google font -->
        ...
        <section class="department-one-section">
            <div class="container">
                ...
                <div class="row row-gutter-30">
                    <?php
						if (empty($result)) {
							echo "<h2 style='margin-bottom: 50px;'>Health</h2>";
						}
						else {
                            ...
                            <b><span class="close" onclick="closeModal('<?php echo $modalId; ?>')">&times;</span>
                                <div class="modal-body">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <p><strong>Patient Capacity</strong>:<?php echo $row['patientcapacity']; ?></p>
                                        <p><strong>Description</strong>: <?php echo $row['description']; ?></p>
                                        <p><strong>Hours</strong>: (Hours might differ)<br>
                                            <?php $timings = json_decode($row['timeduration'], true); ?>
